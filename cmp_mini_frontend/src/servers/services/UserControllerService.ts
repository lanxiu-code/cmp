...
import type { BaseResponse_LoginInfo_ } from '../models/BaseResponse_LoginInfo_';
...
export class UserControllerService {
     ...
     * @returns BaseResponse_LoginInfo_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static userLoginUsingPost(
        userLoginRequest: UserLoginRequest,
    ): CancelablePromise<BaseResponse_LoginInfo_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
